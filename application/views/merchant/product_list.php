            ...
            <div class="page-content">
                <div class="container-fluid ">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><?php $getType = getWhereData('tbl_merchant_pprice', array('mid' => sessionId('mid'), 'p_id' => $fetchrow['product_id']));
                                                                        $prodpr = 0;
                                                                        if ($getType != '') {
                                                                            $prodpr = $getType[0]['pprice'];
                                                                        }
                                                                        ?>
                                                                        <input class="form-control" type="number" name="pprice[]" value="<?= $prodpr; ?>" style="max-width:200px">
                        ...
                        <div style="color:#ffffff !important; background-color:#29bbe3;" class="ctc_bar" id="click_to_call_bar""> 
            <button type=" submit" class=" btn btn-dark">Update Price </button></div>
                    </form>
