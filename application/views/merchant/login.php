...
<body data-topbar="colored">
    <div class="account-pages" style="background-image: url(<?= base_url('assets/admin/images/dark-bg.jpg') ?>);"></div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="p-3">
                    ...
                    <h4 class="text-muted font-size-18 text-center">Welcome Back Merchant!</h4>
                    ...
                    <form class="form-horizontal" method="POST" action="<?php echo base_url() . 'admin/merchantlogin'; ?>">
                        ...
                        <div class="mb-3 row">
                            ...
                            <a href="<?= base_url('Index/merchant_forget_password') ?>" class="text-center"> Forget password ?? </a>
                        </div>
                    </form>
                </div>
            </div>
