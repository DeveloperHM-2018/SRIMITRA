                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="<?php echo base_url() . 'admin_Dashboard/deletecollabarate/' . $row['cid']; ?>" class="btn btn-primary delete" onclick="return confirm('Are you sure ?')"><i class="fas fa-trash-alt"></i></a>
                                                        </td>
                                                    </tr>
