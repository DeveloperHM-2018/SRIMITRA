                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="<?php echo base_url() . 'admin_Dashboard/deletedocument/' . $fetchrow['id']; ?>" onclick="return confirm('Are you sure?')" class="btn btn-primary delete"><i class="fas fa-trash-alt"></i></a>
                                                            </td>
                                                        </tr>
