                                    ...
                                    ">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    ...
                                                    <span class="badge btn-info"><?php echo getNumRows('products', array('category_id' => $row['category_id'])); ?> products</span></td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <a href="<?php echo base_url() . 'admin_Dashboard/deletecategory/' . $row['category_id']; ?>" class="btn btn-primary delete"><i class="fas fa-trash-alt"></i></a>
                                                        </td>
                                                    </tr>
